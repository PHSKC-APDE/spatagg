...
Note: there is no reason to use the spatagg package if your data are available at the point level. This example exists as an idealized case. More generally, you are going to have some sort of areal population expressed as points (see below). That is really what the 'point pop' method is for.
