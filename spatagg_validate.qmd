...
Usually, point population locations and values will be a point based (e.g. centriod) representation of small area. In this case, a few thousand points are distributed within the boundary and population points are aggregated to the closet one. This is to roughly approximate the parcel population estimates made available in the kcparcelpop package. This also reflect how people actually live-- in buildings shared with other and not entirely randomly distributed throughout space.
